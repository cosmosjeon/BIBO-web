...
import { RefObject, useEffect, useRef, useId } from "react"
...
const AnimatedPathText = ({
  ...
  useEffect(() => {
    ...
    scrollData.scrollYProgress.on("change", handleChange)

    return () => {
      scrollData.scrollYProgress.clearListeners()
    }
  }, [scrollData, t, animationType])
